...
export default function AdminDashboard() {
    ...
    const filteredProposals = useMemo(() => {
        return proposals.filter(proposal => {
            ...
            return matchesSearch && matchesType && matchesClub && matchesOvernight && matchesDate;
        });
    }, [proposals, searchQuery, selectedType, selectedClub, selectedOvernight, startDateFilter]);
    ...
    // Export to CSV
    const exportToCSV = () => {
        const headers = ['Event Name', 'Club/Chapter', 'Type', 'Start Date', 'End Date', 'Capacity', 'Overnight', 'Venue', 'Description'];
        const csvContent = [
            headers.join(','),
                    ...
                    <div className="bg-gray-50 border-2 border-black p-4 mb-8">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-bold uppercase text-gray-500 mb-1">Overnight</label>
                                    <select
                                        value={selectedOvernight}
                                        onChange={(e) => setSelectedOvernight(e.target.value)}
                                        className="w-full border-2 border-gray-300 p-2 text-sm focus:border-black focus:outline-none bg-white"
                                    >
                    ...
                    {sortedProposals.length === 0 ? (
                        ...
                        <div className="border-2 border-black bg-white">
                            ...
                            <div className="hidden md:grid grid-cols-12 gap-4 p-4 bg-gray-100 border-b-2 border-black font-bold uppercase text-xs tracking-wider text-gray-600">
                                ...
                                <div className="col-span-1">Overnight</div>
                                    ...
                                    <div key={index} className="border-b border-gray-200 last:border-b-0">
                                        ...
                                        >
                                            ...
                                            <div className="md:col-span-1 flex items-center gap-2 md:block">
                                                <span className="md:hidden text-xs font-bold uppercase text-gray-500 w-20">Overnight:</span>
                                                <span className={`text-xs font-bold uppercase ${proposal.duration.is_overnight ? 'text-purple-600' : 'text-gray-400'}`}>
                                                ...
                                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="bg-white p-4 border border-gray-200">
                                                            <h4 className="font-bold uppercase text-xs text-black mb-3 border-b border-gray-200 pb-2">Full Logistics</h4>
