        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0 mb-6">
            ...
            <button
              type="button"
              onClick={() => router.push('/')}
              className="w-full sm:w-auto bg-white text-black px-4 py-2.5 border-2 border-black hover:bg-black hover:text-white transition-colors font-bold uppercase tracking-wide text-xs sm:text-sm whitespace-nowrap"
            >
              ← Back to Home
            </button>
          </div>
